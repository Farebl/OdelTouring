...
{
	size_t managerIndex = 0, customerIndex = 0, tripIndex = 0, fieldIndex = 0; // ημ³νν³, δλÿ ηαεπεζεννÿ ³νδεκc³β ξαπΰνθυ ξα'Ί³κβς
	int menuItem = 0; // ημ³νν³, δλÿ ηαεπεζεννÿ ³νδεκc³β ξαπΰνξγξ οσνκςσ μενώ
	int index = 0; // ημ³νν³, δλÿ ηαεπεζεννÿ ³νδεκcσ

	std::time_t mytime = std::time(NULL);
	std::tm now = {};
	int current_year = 0; // οξςξχνθι π³κ
	int year = 0; // ημ³νν³, δλÿ ηαεπεζεννÿ ββεδενξγξ πξκσ

	bool try_again = false; // ημ³νν³, δλÿ οεπεβ³πκθ, χθ αΰζΰΊ ελ³Ίνς ββεcςθ νξβε ηνΰχεννÿ ³νδεκcσ
	
	// ημ³νν³, δλÿ ηαεπεζεννÿ βδΰνθυ, οπθ cςβξπενν³ ΰαξ πεδΰγσβΰνν³ ξα'Ίκς³β κλΰc³β
	...
	// ημ³νν³ δλÿ βηΰΊμξδ³Ώ η ξαπΰνθμ ξα'Ίςξμ
	auto manager = Managers.begin(); 
	auto customer = Customers.begin();
	auto trip = Trips.begin();

	// ημ³νν³, δλÿ ηαεπεζεννÿ ψλÿυ³β, δξ τΰιλ³β δΰνθυ
	std::string managersDataPath = ManagersDataPath; // ψλÿυ δξ τΰλισ, κσδθ ηαεπ³γΰώςόcÿ δΰνν³ οπξ μενεδζεπ³β
	std::string customersDataPath = CustomersDataPath; // ψλÿυ δξ τΰλισ, κσδθ ηαεπ³γΰώςόcÿ δΰνν³ οπξ κλ³Ίνς³β
	std::string tripsDataPath = TripsDataPath; // ψλÿυ δξ τΰλισ, κσδθ ηαεπ³γΰώςόcÿ δΰνν³ οπξ οσς³βκθ
	std::string ordersPath = OrdersPath; // ψλÿυ δξ τΰλισ, κσδθ ηαεπ³γΰώςόcÿ δΰνν³ οπξ ηΰμξβλεννÿ
	std::string historyDataPath = HistoryDataPath; // ψλÿυ δξ τΰλισ, κσδθ ηαεπ³γΰώςόcÿ δΰνν³ οπξ ³cςξπ³ώ δ³ι
...
MAIN:
	...
	MANAGERS:
		...
		MANAGERS_INFORMATION:
			...
			MANAGERS_LIST:
				...
				if (Managers.empty()) {
					while (true) {
						...
						case 3:
							...
							break; //κ³νεφό case 3: Are you sure you want to close the program?
						}
					}
				} // κ³νεφό if (Managers.empty())
				...
				FULL_INFORMATION_ABOUT_THE_MANAGER:
					...
					if (managerIndex < 1 || managerIndex > Managers.size()) {
						while (true) {
							...
							case 5:
								...
								break; //κ³νεφό case 5: Are you sure you want to close the program?
							}
						} //κ³νεφό while (true) 
					}//κ³νεφό if (managerIndex < 1 || managerIndex > Managers.size()) 
					...
					while (true) {
						...
						case 5:
							...
							break; //κ³νεφό case 4: Are you sure you want to close the program?
						}
					}// κ³νεφό while (true) σ DETAILED_INFORMATION_ABOUT_MANAGER:

					break; // κ³νεφό case 1: Show full information about the manager
				...
				SELECT_ANOTHER_FIELD_OF_THE_MANAGER:
						...
						if (fieldIndex < 1 || fieldIndex > 6) {
							while (true) {
								...
								case 6:
									...
									break; //κ³νεφό case 6: Are you sure you want to close the program?
								}
					...
					}// κ³νεφό while (true) - Select the number of the manager you want to see full information about:
							...
							if (fieldIndex < 1 || fieldIndex > 3) {
								while (true) {
									...
									case 7:
										...
										break; //κ³νεφό case 7: Are you sure you want to close the program?
									}
					...
					}// κ³νεφό case 2: - No - while (true) σ DETAILED_INFORMATION_ABOUT_MANAGER

					break;  // κ³νεφό case 2: Edit information about the manager

				case 3: // case 3: Back to MANAGERS
					ClearConsole();
					goto MANAGERS;
					break; //κ³νεφό case 3: Back to MANAGERS

				case 4: // case 4: Back to the main menu
				default:
					ClearConsole();
					goto MAIN;
					break; //κ³νεφό case 4: Back to the main menu

				case 5: // case 5: Close the program
					ClearConsole();
					return;
					break; //κ³νεφό case 5: Close the program
				}

				break; //κ³νεφό case 1: List of managers (full info/edit)
			...
			COUNT_OF_MANAGERS:
				...
				break; //κ³νεφό case 2: Count of managers
			...
			break; //κ³νεφό case 1: Information
		...
		MANAGER_ORDERS:
			...
			MAKE_A_TRIP_PURCAHSE:
				...
				} // κ³νεφό if (GetCountOfCustomersWithoutTrip(Customers) == 0)
				...
				} // κ³νεφό if (GetCountOfUnboughtTrips(Trips)  == 0)
				...
				break;//κ³νεφό case 1:  Make a tour purchase
			...
			MAKE_A_TRIP_REFOUND: 
				...
				} // κ³νεφό if (GetCountOfCustomersWithTrip(Customers) == 0)
				...
				break;//κ³νεφό case 1:  Make a tour refund
		...
		ADD_NEW_MANAGER:
			...
			break; //κ³νεφό case 3: Add new manager
		...
		REMOVE_MANAGER:
			...
			break; //κ³νεφό  case 4: Remove manager

		case 5: // case 5: Back to the main menu
		default:
			ClearConsole();
			goto MAIN;
			break; //κ³νεφό case 5: Back to the main menu
	...
	CUSTOMERS:
		...
		CUSTOMERS_INFORMATION:
			...
			CUSTOMERS_LIST:
				...
				FULL_INFORMATION_ABOUT_THE_CUSTOMER:
					...
					}//κ³νεφό if (customerIndex < 1 || customerIndex > Customers.size()) 
					...
					break; // κ³νεφό case 1: Show full information about the customer
				...
				SELECT_ANOTHER_FIELD_OF_THE_CUSTOMER:
					...
					while (true) {
						...
						if (fieldIndex < 1 || fieldIndex > 6) {
							while (true) {
								...
								break;
							} //κ³νεφό if (fieldIndex < 1 || fieldIndex > 4)
						}
					...
					}// κ³νεφό while (true) - Select the number of the field, that you want to edit: :
						...
						while (true) {
							...
							if (fieldIndex < 1 || fieldIndex > 3) {
								while (true) {
									...
									break;
								} //κ³νεφό if (customerIndex < 1 ||customerIndex > Managers.size()) 
							}
				...
				case 3: // case 3: Back to CUSTOMERS
					ClearConsole();
					goto CUSTOMERS;
					break; //κ³νεφό case 3: Back to CUSTOMERS
				...
				break; //κ³νεφό case 1: List of customer (full info/edit)
			...
			CUSTOMERS_LIST_BY_COUNTRY:
				...
				break; //κ³νεφό case 2: List of customers by trip`s country 
			...
			case 6: // case 6: Close the program
				ClearConsole();
				return;
				break; //κ³νεφό case 6: Close the program
			}
		...
		ADD_NEW_CUSTOMER:
			...
			break; //κ³νεφό case 2: Add new customer
		...
		REMOVE_CUSTOMER:
			...
			break; //κ³νεφό case 3: Remove customer

		case 4: // case 4: Back to \"Main menu\""
		default:
			ClearConsole();
			goto MAIN;
			break; //κ³νεφό case 4: Back to \"Main menu\""
	...
	TRIPS:
		...
		TRIPS_INFORMATION:
			...
			TRIPS_LIST:
				...
				break; //κ³νεφό case 1: Trips get information
			...
			GENERAL_INFORMATION_ABOUT_TRIPS:
				...
				GENERAL_INFORMATION_ABOUT_TRIPS_BY_YEAR:
					...
					break; // κ³νεφό case 1: yes - see a general information about trips for a specific year
				...
				default:
					...
					break;// κ³νεφό case 1: no
				}

				break; //κ³νεφό case 2: General information

			case 3: // case 3: Back to TRIPS
				ClearConsole();
				goto TRIPS;
				break; //κ³νεφό case 3: Back to TRIPS
		...
		ADD_NEW_TRIP:
			...
			break; //κ³νεφό case 2: Add new trip
		...
		REMOVE_TRIP:
			...
			break; //κ³νεφό case 3: Remove trip
		
		case 4: // case 4: Back to the MAIN
		default:
			ClearConsole();
			goto MAIN;
			break; //κ³νεφό case 4: Back to the MAIN
		...
		break; //κ³νεφό case 3: Trips

case 4: // case 4: Close the program
	return;
	break; //κ³νεφό case 4: Close the program
	}
